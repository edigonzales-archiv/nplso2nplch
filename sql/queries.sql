...
DELETE FROM npl_ch.geobasisdaten_ueberlagernde_festlegung;
DELETE FROM npl_ch.geobasisdaten_linienbezogene_festlegung;
DELETE FROM npl_ch.geobasisdaten_objektbezogene_festlegung;
...
(
  ...
  SELECT
    ...
    hn.t_id AS hauptnutzung_ch
  FROM
    npl_so.nutzungsplanung_np_typ_kanton_ueberlagernd_flaeche AS fl
    LEFT JOIN 
      npl_ch.hauptnutzung_ch_hauptnutzung_ch AS hn
      ON 
        hn.code::text = substring(ilicode FROM 2 FOR 2)
...
(
  ...
  FROM
    npl_so.nutzungsplanung_typ_ueberlagernd_flaeche AS typ
    JOIN
...
(
  SELECT
    ...
    flaeche.geometrie
  FROM
    npl_so.nutzungsplanung_ueberlagernd_flaeche AS flaeche
...
(
  INSERT INTO npl_ch.geobasisdaten_ueberlagernde_festlegung
    (
      t_id,
      publiziertab,
      rechtsstatus,
...
(
  ...
  SELECT
    ...
    hn.t_id AS hauptnutzung_ch
  FROM
    npl_so.nutzungsplanung_np_typ_kanton_ueberlagernd_linie AS li
    LEFT JOIN 
      npl_ch.hauptnutzung_ch_hauptnutzung_ch AS hn
      ON 
        hn.code::text = substring(ilicode FROM 2 FOR 2)
...
(
  ...
  FROM
    npl_so.nutzungsplanung_typ_ueberlagernd_linie AS typ
    JOIN
...
(
  SELECT
    ...
    linie.geometrie
  FROM
    npl_so.nutzungsplanung_ueberlagernd_linie AS linie
...
(
  INSERT INTO npl_ch.geobasisdaten_linienbezogene_festlegung
    (
      t_id,
      publiziertab,
      rechtsstatus,
...
(
  ...
  SELECT
    ...
    hn.t_id AS hauptnutzung_ch
  FROM
    npl_so.nutzungsplanung_np_typ_kanton_ueberlagernd_punkt AS pn
    LEFT JOIN 
      npl_ch.hauptnutzung_ch_hauptnutzung_ch AS hn
      ON 
        hn.code::text = substring(ilicode FROM 2 FOR 2)
...
(
  ...
  FROM
    npl_so.nutzungsplanung_typ_ueberlagernd_punkt AS typ
    JOIN
...
(
  SELECT
    ...
    punkt.geometrie
  FROM
    npl_so.nutzungsplanung_ueberlagernd_punkt AS punkt
...
(
  INSERT INTO npl_ch.geobasisdaten_objektbezogene_festlegung
    (
      t_id,
      publiziertab,
      rechtsstatus,
...
FROM
  --typ_kt_ueberlagernd_linie  
objektbezogene_festlegung_insert
