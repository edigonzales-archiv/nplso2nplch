...
(
  ...
  FROM
    ...
    LEFT JOIN 
      ...
      ON 
        hn.acode::text = substring(ilicode FROM 2 FOR 2)
  RETURNING *
),
/*
...
(
  ...
  FROM
    ...
    LEFT JOIN
      typ_kt_grundnutzung
      ON
        typ_kt_grundnutzung.acode = substring(typ.typ_kt FROM 2 FOR 3)
),
...
(
  ...
  FROM
    ...
    JOIN
      ...
      ON
        typ_kt_ueberlagernd_flaeche.acode = substring(typ.typ_kt FROM 2 FOR 3)
),
...
(
  ...
  FROM
    ...
    JOIN
      ...
      ON
        typ_kt_ueberlagernd_linie.acode = substring(typ.typ_kt FROM 2 FOR 3)
),
...
(
  ...
  FROM
    ...
    JOIN
      ...
      ON
        typ_kt_ueberlagernd_punkt.acode = substring(typ.typ_kt FROM 2 FOR 3)
),
